...
[![CI](https://github.com/hdvergara/selenium_python_pom/actions/workflows/ci.yml/badge.svg)](https://github.com/hdvergara/selenium_python_pom/actions/workflows/ci.yml)
[![Allure Report](https://img.shields.io/badge/Allure%20Report-view%20live-FF6C37.svg)](https://hdvergara.github.io/selenium_python_pom/)

</div>

**Latest test report (Allure on GitHub Pages):** [https://hdvergara.github.io/selenium_python_pom/](https://hdvergara.github.io/selenium_python_pom/)
...
3. After the first successful deployment job, the Pages URL appears in the **deploy** job log and under **Settings → Pages**.

### Where to open the Allure report (GitHub Pages URL)

The CI workflow publishes the **static Allure HTML** to this repository’s **GitHub Pages** site. Anyone browsing the repo can open the latest report with one click:

**[https://hdvergara.github.io/selenium_python_pom/](https://hdvergara.github.io/selenium_python_pom/)**

That link is also available at the top of this README (badge **Allure Report** and the line under the badges).

| Repository | Live Allure report |
|------------|-------------------|
| [github.com/hdvergara/selenium_python_pom](https://github.com/hdvergara/selenium_python_pom) | [hdvergara.github.io/selenium_python_pom](https://hdvergara.github.io/selenium_python_pom/) |

**How to confirm the URL after a new deployment**

1. **Actions** → **CI** run → job **Deploy Allure to GitHub Pages** → **`github-pages` environment** or step output (**page_url**).
2. **Settings → Pages** → **Visit site**.

**Note:** Pull requests do not update the published site; only runs on the **default branch** (push / schedule / manual dispatch) refresh the report.
